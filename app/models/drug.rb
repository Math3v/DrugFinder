...
class Drug < ActiveRecord::Base
  ...
  def self.generate_string_to_execute params
    ...
    while i < parlen
      ...
      param_string[i]='\mkrk\M|\mmandl_\M|\mkrku\M|\mpa_er_ka' if params[i].eql? '8'
      ...
      param_string[i]='\msemenn|\mpenis|\mvaje_n_k|\mmie_ka\M|\mmie_ok\M|\mpo_v_\M' if params[i].eql? '17'
